...
/**
 * Created by IntelliJ IDEA. User: kgalligan Date: 10/9/11 Time: 6:46 PM To change this template use
...
public class DatabaseHelper extends SQLiteOpenHelper {
  ...
  public List<Session> loadAllSessions() {
    ...
    final Cursor sessionCursor = readableDatabase.query("session", SESSION_COLS, null, null, null,
        null, "id", null);
